...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_STATE_CHANGE(), state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_DEVICE_NAME());
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.Companion.getDEVICE_NAME(), device.getName());
        msg.setData(bundle);
    ...
    public void writeWithFormat(byte[] buffer, final byte[] pFormat, final byte[] pAlignment) {
        ...
        r.writeWithFormat(buffer, pFormat, pAlignment);
    }
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_TOAST());
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.Companion.getTOAST(), "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_TOAST());
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.Companion.getTOAST(), "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if (bytes > 0) {
                        ...
                        mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_READ(), bytes, -1, buffer)
                                .sendToTarget();
                    } else {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_WRITE(), -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
        ...
        public void writeWithFormat(byte[] buffer, final byte[] pFormat, final byte[] pAlignment) {
            try {
                ...
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(MainActivity.Companion.getMESSAGE_WRITE(), buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
                Log.e(TAG, "Exception during write", e);
            }
